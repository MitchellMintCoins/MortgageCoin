...
unlocked to sign the Mortgagecoin-Qt.app bundle.
...
allowing somebody to distribute a Mortgagecoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the mortgagecoin-qt.exe file inside the installer had not been tampered with.
